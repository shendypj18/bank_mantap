               ...
               @foreach($kategori_jabatan as $k)
                   ...
                   @if($check)
                       <li class="nav-item nv-item">
                           <a class="nav-link manage @if($c == 1) active @endif" data-toggle="tab" href="{{'#' .$k->nama}}">{{__('admin.txt_tab_'.$k->nama)}}</a>
                       </li>
                   @endif
                   @php $c++; @endphp
               @endforeach
                       ...
                       <div class="container">
                        <div class="row">
                          <div class="col bio-cnt">
                              <div class="row">
                                <div class="col on">
                                    <p>{{__("admin.txt_manajemen_umur")}}</p>
                                </div>
                                <div class="col tu">
                                    <p>{{$p->umur}}</p>
                                </div>
                              ...
                              <div class="row">
                                <div class="col on">
                                    <p>{{__("admin.txt_manajemen_domisili")}}</p>
                                </div>
                                <div class="col tu">
                                    <p>{{$p->domisili}}</p>
                                </div>
                              ...
                              <div class="row">
                                <div class="col on">
                                    <p>{{__("admin.txt_manajemen_pendidikan")}}</p>
                                </div>
                                <div class="col tu">
                                    <p>{{$p->pendidikan}}</p>
                                </div>
                              ...
                              <div class="row">
                                <div class="col on">
                                    <p>{{__("admin.txt_manajemen_pengalaman_kerja")}}</p>
                                </div>
                              ...
                              <div class="row">
                                <div class="col on">
                                    <p>{{__("admin.txt_manajemen_posisi")}}</p>
                                </div>
                                <div class="col tu">
                              ...
                              <div class="row">
                                <div class="col on">
                                    <p>{{__("admin.txt_manajemen_dasar_hukum")}}</p>
                                </div>
                                <div class="col tu">
                              ...
                              <div class="row">
                                <div class="col on">
                                    <p>{{__("admin.txt_manajemen_hubungan_afiliasi")}}</p>
                                </div>
                                <div class="col tu">
                              ...
                              <div class="row">
                                <div class="col on">
                                    <p>{{__("admin.txt_manajemen_masa_jabatan")}}</p>
                                </div>
                                <div class="col tu">
                                    <p>{{$p->masa_jabatan}}</p>
                                </div>
