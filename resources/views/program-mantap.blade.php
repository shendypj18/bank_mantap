        ...
        <div class="row">
            ...
            @foreach ($pages["Program Mantap"] as $page)
                ...
                <div class="col-sm-3 mb-5 pad-sz">
                    <div class="card mb-2" style="height: fit-cntent; box-shadow: 0px 20px 40px #75B2DD1A;border-radius: 12px 12px 0px 0px; opacity: 1;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text text-left fz" style="color:#0F2B5B; cursor:pointer;" onclick="location.href='{{url('info/'. $page[$bahasa. '_slug'] .'/'. $bahasa)}}'">
                                @if(strlen($page[$bahasa. '_judul']) > 55)
                                    {{ substr($page[$bahasa. '_judul'], 0, 55) . '....'}}
                                @else
                                    {{$page[$bahasa. '_judul']}}
                                @endif
                            </p>
